...
public class GUI extends JFrame implements ActionListener
{
    ...
    public GUI(Chat parent)
    {
        ...
        chatField.setActionCommand("sendField");
        ...
        chatArea.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 8));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getActionCommand().equals("sendButton") || e.getActionCommand().equals("sendField"))
